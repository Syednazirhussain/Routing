...
namespace Massive400 {

    public class AS400Pgm
    {
    ...
    public class DynamicModel : DynamicObject {
        ...
        public DynamicModel(string connectionStringName, string tableName = "", string primaryKeyField = "") {
            ...
            var _providerName = "IBM.Data.DB2.iSeries";
        ...
        public virtual object Insert(object o) {
            ...
            using (var conn = OpenConnection()) {
                ...
                cmd.Connection = conn;
                cmd.ExecuteNonQuery();
                cmd.CommandText = "SELECT IDENTITY_VAL_LOCAL() AS NEWID FROM SYSIBM.SYSDUMMY1";
        ...
        private static string BuildSelect(string where, string orderBy, int limit) {
            string sql = limit > 0 ? "SELECT {0} FROM {1} FETCH FIRST " + limit + " ROW ONLY " : "SELECT {0} FROM {1} ";
        ...
        public override bool TryInvokeMember(InvokeMemberBinder binder, object[] args, out object result) {
            ...
            if (op.StartsWith("Last")) {
                orderBy = orderBy + " DESC FETCH FIRST 1 ROWS ONLY";
            } else {
                //default to multiple
